        ...
        <>
            <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rem] h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? "translate-x-0" : "translate-x-full"}`}>
                ...
                <div className='flex-grow p-4 overflow-y-auto'>
                    <h2 className='sticky top-0 text-xl font-semibold mb-4 '>Your Cart</h2>
                ...
                <div className='p-4 bg-white sticky bottom-0'>
                    <button onClick={handleCheckout} className='w-full bg-black text-white py-3 rounded-lg hover:bg-gray-800 font-semibold transition-all'>
                        Checkout
                    </button>
